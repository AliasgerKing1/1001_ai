        ...
        <section className="nft-item__area">
            <div className="container custom-container">
                <div className="row justify-content-center">
                    ...
                    <div className="col-xxl-4 col-xl-5 col-lg-6 col-md-9 d-flex justify-content-center">
                        <NavLink to='/auth/games/list' type='button' className="tg-btn-2">View All</NavLink>
                    </div>
                </div>
            </div>
        </section>
