                      ...
                      <div className="col-xl mb-md-0 mb-4">
                        <div className="card border rounded shadow-none">
                          <div className="card-body">
                            ...
                            <button type="button" className="btn btn-label-success d-grid w-100 mt-3" data-bs-dismiss="modal">Your Current Plan</button>
                          </div>
                        </div>
                      </div>
                      {/* Pro */}
                        ...
                        <div className="card border-primary border shadow-none">
                          <div className="card-body position-relative">
                            ...
                            <div className="text-center h-px-100 mb-2">
                              <div className="d-flex justify-content-center">
                                <sup className="h6 pricing-currency mt-3 mb-0 me-1 text-primary">$</sup>
                                <h1 className="price-toggle price-yearly display-4 text-primary mb-0">7</h1>
                                <h1 className="price-toggle price-monthly display-4 text-primary mb-0 d-none">9</h1>
                          ...
                          <div className="card-body">
                            ...
                            <div className="text-center h-px-100 mb-2">
                              <div className="d-flex justify-content-center">
                                ...
                                <h1 className="price-toggle price-yearly display-4 text-primary mb-0">16</h1>
                                <h1 className="price-toggle price-monthly display-4 text-primary mb-0 d-none">19</h1>
                            ...
                            <button type="button" className="btn btn-label-primary d-grid w-100 mt-3" data-bs-dismiss="modal">Upgrade</button>
                          </div>
                        </div>
                      </div>
                    </div>
