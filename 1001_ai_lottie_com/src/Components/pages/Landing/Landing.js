                ...
                <div className="swiper-wrapper">
                    ...
                    <div className="row">
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center">
                          <img src="../../assets/img/illustrations/card-website-analytics-1.png" alt="Website Analytics" width={170} className="card-website-analytics-img" />
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="swiper-slide">
                    <div className="row">
                      ...
                      <div className="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center">
                        <img src="../../assets/img/illustrations/card-website-analytics-2.png" alt="Website Analytics" width={170} className="card-website-analytics-img" />
                      </div>
                    </div>
                  </div>
                  <div className="swiper-slide">
                    <div className="row">
                      ...
                      <div className="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center">
                        <img src="../../assets/img/illustrations/card-website-analytics-3.png" alt="Website Analytics" width={170} className="card-website-analytics-img" />
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="row">
                    <div className="col-4">
                      <div className="d-flex gap-2 align-items-center mb-2">
                        <span className="badge bg-label-info p-1 rounded"><i className="ti ti-shopping-cart ti-xs" /></span>
                        <p className="mb-0">Order</p>
                      </div>
                    ...
                    <div className="col-4 text-end">
                      <div className="d-flex gap-2 justify-content-end align-items-center mb-2">
                        ...
                        <span className="badge bg-label-primary p-1 rounded"><i className="ti ti-link ti-xs" /></span>
                      </div>
                    ...
                    <div className="row gap-4 gap-sm-0">
                      <div className="col-12 col-sm-4">
                        <div className="d-flex gap-2 align-items-center">
                          <div className="badge rounded bg-label-primary p-1"><i className="ti ti-currency-dollar ti-sm" /></div>
                      ...
                      <div className="col-12 col-sm-4">
                        <div className="d-flex gap-2 align-items-center">
                          <div className="badge rounded bg-label-info p-1"><i className="ti ti-chart-pie-2 ti-sm" /></div>
                      ...
                      <div className="col-12 col-sm-4">
                        <div className="d-flex gap-2 align-items-center">
                          <div className="badge rounded bg-label-danger p-1"><i className="ti ti-brand-paypal ti-sm" /></div>
                    ...
                    <div className="col-12 col-sm-4 col-md-12 col-lg-4">
                      ...
                      <ul className="p-0 m-0">
                        <li className="d-flex gap-3 align-items-center mb-lg-3 pt-2 pb-1">
                          <div className="badge rounded bg-label-primary p-1"><i className="ti ti-ticket ti-sm" /></div>
                          <div>
                        ...
                        <li className="d-flex gap-3 align-items-center mb-lg-3 pb-1">
                          <div className="badge rounded bg-label-info p-1"><i className="ti ti-circle-check ti-sm" /></div>
                          <div>
                        ...
                        <li className="d-flex gap-3 align-items-center pb-1">
                          <div className="badge rounded bg-label-warning p-1"><i className="ti ti-clock ti-sm" /></div>
                          <div>
                ...
                <div className="card-body">
                  <ul className="p-0 m-0">
                    <li className="d-flex align-items-center mb-4">
                      <img src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/svg/flags/us.svg" alt="User" className="rounded-circle me-3" width={34} />
                    ...
                    <li className="d-flex align-items-center mb-4">
                      <img src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/svg/flags/br.svg" alt="User" className="rounded-circle me-3" width={34} />
                      <div className="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                        <div className="me-2">
                          <div className="d-flex align-items-center">
                    ...
                    <li className="d-flex align-items-center mb-4">
                      <img src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/svg/flags/in.svg" alt="User" className="rounded-circle me-3" width={34} />
                      <div className="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                        <div className="me-2">
                          <div className="d-flex align-items-center">
                    ...
                    <li className="d-flex align-items-center mb-4">
                      <img src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/svg/flags/au.svg" alt="User" className="rounded-circle me-3" width={34} />
                      <div className="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                        <div className="me-2">
                          <div className="d-flex align-items-center">
                    ...
                    <li className="d-flex align-items-center mb-4">
                      <img src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/svg/flags/fr.svg" alt="User" className="rounded-circle me-3" width={34} />
                      <div className="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                        <div className="me-2">
                          <div className="d-flex align-items-center">
                    ...
                    <li className="d-flex align-items-center">
                      <img src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/svg/flags/cn.svg" alt="User" className="rounded-circle me-3" width={34} />
                      <div className="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                        <div className="me-2">
                          <div className="d-flex align-items-center">
              ...
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <div className="d-flex align-items-start my-4">
                    <div className="badge rounded bg-label-primary p-2 me-3 rounded"><i className="ti ti-currency-dollar ti-sm" /></div>
                  ...
                  <div className="d-flex align-items-start">
                    <div className="badge rounded bg-label-secondary p-2 me-3 rounded"><i className="ti ti-brand-paypal ti-sm" /></div>
                    <div className="d-flex justify-content-between w-100 gap-2 align-items-center">
                      <div className="me-2">
            ...
            <div className="col-xl-4 col-md-6 mb-4">
              <div className="card h-100">
                <div className="card-header d-flex justify-content-between">
                  ...
                  <div className="dropdown">
                    <button className="btn p-0" type="button" id="MonthlyCampaign" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <i className="ti ti-dots-vertical ti-sm text-muted" />
                    </button>
                ...
                <div className="card-body">
                  <ul className="p-0 m-0">
                    <li className="mb-4 pb-1 d-flex justify-content-between align-items-center">
                      <div className="badge bg-label-success rounded p-2"><i className="ti ti-mail ti-sm" /></div>
                    ...
                    <li className="mb-4 pb-1 d-flex justify-content-between align-items-center">
                      <div className="badge bg-label-info rounded p-2"><i className="ti ti-link ti-sm" /></div>
                      <div className="d-flex justify-content-between w-100 flex-wrap">
                    ...
                    <li className="mb-4 pb-1 d-flex justify-content-between align-items-center">
                      <div className="badge bg-label-warning rounded p-2"><i className="ti ti-click ti-sm" /></div>
                      <div className="d-flex justify-content-between w-100 flex-wrap">
                    ...
                    <li className="mb-4 pb-1 d-flex justify-content-between align-items-center">
                      <div className="badge bg-label-primary rounded p-2"><i className="ti ti-users ti-sm" /></div>
                      <div className="d-flex justify-content-between w-100 flex-wrap">
                    ...
                    <li className="mb-4 pb-1 d-flex justify-content-between align-items-center">
                      <div className="badge bg-label-secondary rounded p-2"><i className="ti ti-alert-triangle ti-sm text-body" /></div>
                      <div className="d-flex justify-content-between w-100 flex-wrap">
                    ...
                    <li className="d-flex justify-content-between align-items-center">
                      <div className="badge bg-label-danger rounded p-2"><i className="ti ti-ban ti-sm" /></div>
                      <div className="d-flex justify-content-between w-100 flex-wrap">
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <ul className="list-unstyled mb-0">
                    ...
                    <li className="mb-3 pb-1">
                      <div className="d-flex align-items-start">
                        <div className="badge bg-label-secondary p-2 me-3 rounded"><i className="ti ti-globe ti-sm" /></div>
                        <div className="d-flex justify-content-between w-100 flex-wrap gap-2">
                          <div className="me-2">
                    ...
                    <li className="mb-3 pb-1">
                      <div className="d-flex align-items-start">
                        <div className="badge bg-label-secondary p-2 me-3 rounded"><i className="ti ti-mail ti-sm" /></div>
                        <div className="d-flex justify-content-between w-100 flex-wrap gap-2">
                          <div className="me-2">
                    ...
                    <li className="mb-3 pb-1">
                      <div className="d-flex align-items-start">
                        <div className="badge bg-label-secondary p-2 me-3 rounded"><i className="ti ti-external-link ti-sm" /></div>
                        <div className="d-flex justify-content-between w-100 flex-wrap gap-2">
                          <div className="me-2">
                    ...
                    <li className="mb-3 pb-1">
                      <div className="d-flex align-items-start">
                        <div className="badge bg-label-secondary p-2 me-3 rounded"><i className="ti ti-discount-2 ti-sm" /></div>
                        <div className="d-flex justify-content-between w-100 flex-wrap gap-2">
                          <div className="me-2">
                    ...
                    <li className="mb-2">
                      <div className="d-flex align-items-start">
                        <div className="badge bg-label-secondary p-2 me-3 rounded"><i className="ti ti-star ti-sm" /></div>
                        <div className="d-flex justify-content-between w-100 flex-wrap gap-2">
                          <div className="me-2">
