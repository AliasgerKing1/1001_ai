      ...
      <div className="w-px-400 mx-auto">
        ...
        <form id="formAuthentication" className="mb-3">
          ...
          <label htmlFor="email" className="form-label">{form.email_username_label}</label>
              <Input_Email_Username type="text" className="form-control" id="email" name="email-username" placeholder={form.email_placeholder?.length !== 0 ? (form.email_placeholder) : "Enter your email or username"} />
          </div>
          <div className="mb-3 form-password-toggle">
            ...
            <Input_Password id="password" name="password" placeholder={form.password_placeholder?.length !== 0 ? (form.password_placeholder) : "············"} />
