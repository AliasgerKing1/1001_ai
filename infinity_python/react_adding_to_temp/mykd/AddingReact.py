...
# directoryx = r"C:\Users\ACER\Desktop\Mkyd\mykd"

# # Call the function to find HTML files
# html_files = find_html_files(directoryx)

# # Extract the folder path from the first HTML file
# file_path_xy = ""
# # Print the list of HTML files
# file_path_xy = html_files[0].rsplit("\\", 1)[0]

# source_pathx = file_path_xy
# destination_pathx = fr"C:\Users\ACER\Desktop\1001_ai\infinity_python\react_adding_to_temp\mykd\theme\{WebsiteName}"
...
#     folders_to_copy = ['bootstrap', 'css', 'fonts', 'images', 'js', 'video', 'dist', 'libs', 'jquery', 'audio']
#     assets_folder = None
...
#         shutil.copytree(assets_folder, destination_dir)
#     else:
#         for root, dirs, files in os.walk(source_dir):
#             for folder in dirs:
#                 if folder in folders_to_copy:
#                     folder_path = os.path.join(root, folder)
#                     destination_path = os.path.join(destination_dir, folder)
#                     shutil.copytree(folder_path, destination_path)

# source_directory = "directoryx"
# destination_directory = r"C:\Users\ACER\Desktop\1001_ai\infinity_python\react_adding_to_temp\mykd\code\{WebsiteName}\public\assets"
...
#   modified_contents = file_contents.replace('class="', 'className="')
    ...
    for root, dirs, files in os.walk(directory):
        ...
        for file in files:
            if file.endswith(".html"):
                html_files.append(os.path.join(root, file))
        if len(html_files) > 4:
            folders_with_html.append(root)
    return folders_with_html

def copy_html_files(folders, destination):
    for folder in folders:
        ...
        for file in html_files:
            ...
            if os.path.exists(destination_path):
                ...
                destination_path = os.path.join(destination, new_file_name)
                html_destination.append(destination_path)
            shutil.copytree(file, destination_path)

directoryx = r"C:\Users\ACER\Desktop\Mkyd\demo27"
destination = fr"C:\Users\ACER\Desktop\1001_ai\infinity_python\react_adding_to_temp\mykd\theme\{WebsiteName}"

folders_with_html = find_html_files(directoryx)
copy_html_files(folders_with_html, destination)


# Extract the folder path from the first HTML file
file_path_xy = ""
# Print the list of HTML files
file_path_xy = html_destination[0]
print(file_path_xy)
# # lst1= os.listdir(fr"H:\1001_ai\infinity_python\react_adding_to_temp\mykd\theme\{WebsiteName}")
# # lst1= os.listdir(fr"C:\Users\hp\Desktop\1001_ai\infinity_python\react_adding_to_temp\mykd\theme\{WebsiteName}")
# lst1= os.listdir(fr"C:\Users\ACER\Desktop\1001_ai\infinity_python\react_adding_to_temp\mykd\theme\{WebsiteName}")
...
for index, router in enumerate(lst1) :
    lst2= os.listdir(fr"C:\Users\ACER\Desktop\1001_ai\infinity_python\react_adding_to_temp\mykd\theme\{WebsiteName}\{router}")
    for index, router2 in enumerate(lst2) :
        routes0 = router2.split(".")[0]
        routes00 = routes0.split("-")[0]
        if routes00 not in unique_values:
            unique_values.add(routes00)
# # ----------------------------------------------------------------------------------------------------------------   
# # Specify the source and destination paths
# # source_path = r"H:\\1001_ai\ReactApp"
# source_path = r"C:\Users\ACER\Desktop\1001_ai\ReactApp"
