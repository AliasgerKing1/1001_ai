            ...
            <div className="contactpage">
              <div className="container small">
                  ...
                  <form action="https://frenify.com/" method="post" className="contact_form" id="contact_form" autoComplete="off">
                    <div className="input_list">
                      <ul>
                        ...
                        <li>
                          <div>
                            <a id="send_message" href="#" className="techwave_fn_button">
                ...
                <p>Contact Information:<br />
                  Phone: <span className="heading_color">+91 62320 53953</span><br />
                  Address: <span className="heading_color">infinityai.info@gmail.com</span></p>
                <p>Please note that our office hours are 9 am to 9 pm . While we endeavor to respond to all inquiries promptly, there may be slight delays during weekends and holidays.</p>
              </div>
            </div>
          </div>
          {/* !FAQ Page */}
